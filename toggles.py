...
@invocation(
    "bool_collection_toggle",
    title="Bool Collection Toggle",
    tags=["bool", "collection", "toggle"],
    category="toggle",
    version="1.0.0",
)
...
@invocation(
    "int_collection_toggle",
    title="Integer Collection Toggle",
    tags=["int", "integer", "collection", "toggle"],
    category="toggle",
    version="1.0.0",
)
...
@invocation(
    "float_collection_toggle",
    title="Float Collection Toggle",
    tags=["float", "collection", "toggle"],
    category="toggle",
    version="1.0.0",
)
...
# region String
@invocation(
    "string_toggle", title="String Toggle", tags=["str", "string", "toggle"], category="toggle", version="1.0.0"
)
...
@invocation(
    "string_collection_toggle",
    title="String Collection Toggle",
    tags=["str", "string", "collection", "toggle"],
    category="toggle",
    version="1.0.0",
)
...
@invocation(
    "image_collection_toggle",
    title="Image Collection Toggle",
    tags=["image", "collection", "toggle"],
    category="toggle",
    version="1.0.0",
)
...
class LoRACollectionToggleOutput(BaseInvocationOutput):
    collection: list[LoRAField] = OutputField(
        description="Collection of LoRA models and weights", title="LoRA Collection"
    )


@invocation(
    "lora_collection_toggle",
    title="LoRA Collection Toggle",
    tags=["lora", "collection", "toggle"],
    category="toggle",
    version="1.0.0",
)
...
# region Scheduler
@invocation(
    "scheduler_toggle", title="Scheduler Toggle", tags=["scheduler", "toggle"], category="toggle", version="1.0.0"
)
...
@invocation(
    "sdxl_main_model_toggle",
    title="SDXL Main Model Toggle",
    tags=["model", "sdxl", "toggle"],
    category="toggle",
    version="1.0.0",
)
...
@invocation(
    "conditioning_toggle",
    title="Conditioning Toggle",
    tags=["conditioning", "toggle"],
    category="toggle",
    version="1.0.0",
)
...
@invocation(
    "conditioning_collection_toggle",
    title="Conditioning Collection Toggle",
    tags=["conditioning", "collection", "toggle"],
    category="toggle",
    version="1.0.0",
)
...
@invocation(
    "flux_conditioning_toggle",
    title="FLUX Conditioning Toggle",
    tags=["conditioning", "toggle", "flux"],
    category="toggle",
    version="1.0.0",
)
...
@invocation(
    "flux_conditioning_collection_toggle",
    title="FLUX Conditioning Collection Toggle",
    tags=["conditioning", "collection", "toggle", "flux"],
    category="toggle",
    version="1.0.1",
)
