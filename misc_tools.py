...
@invocation(
    "random_image_size_invocation",
    title="Random Image Size",
    tags=["size", "image", "dimensions"],
    category="size",
    version="1.0.0",
)
class RandomImageSizeInvocation(BaseInvocation):
    ...
    seed: int = InputField(
        title="Seed", description="A seed for the randomness. Use -1 for non-deterministic.", default=-1
    )
    size_list: str = InputField(
        title="Size List", description="", default="1024x1024,888x1184,1184x888,840x1256,1256x840,768x1368,1368x768"
    )
