...
@invocation(
    "lora_name_grabber_invocation",
    title="LoRA Name Grabber",
    tags=["model, lora, string"],
    category="model",
    version="1.0.0",
)
class LoRANameGrabberInvocation(BaseInvocation):
    ...
    lora: LoRAField = InputField(
        title="LoRA", description="The LoRA whose name you wish to grab. Get this from a LoRA Selector node."
    )
...
@invocation(
    "model_name_grabber_invocation",
    title="Model Name Grabber",
    tags=["model, string"],
    category="model",
    version="1.0.0",
)
